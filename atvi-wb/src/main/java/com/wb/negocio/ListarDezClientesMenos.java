...
public class ListarDezClientesMenos extends Listagem {
	private List<Cliente> clientes;

	public ListarDezClientesMenos(List<Cliente> clientes) {
	...
	public void listar() {
		...
		int count = 0;
		System.out.println("\nLista dos 10 clientes que menos consumiram em quantidade:\n");
