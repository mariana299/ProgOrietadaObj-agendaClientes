...
public class ListarDezClientesMenosServico extends Listagem {
	private List<Cliente> clientes;

	public ListarDezClientesMenosServico(List<Cliente> clientes) {
	...
	public void listar() {
		...
		listaoClientesQtddConsumida.sort(Comparator.comparing(ClienteQtddConsumo::getQtddConsumo));
		...
		int count = 0;
		System.out.println("\nLista dos 10 clientes que menos consumiram serviço em quantidade:\n");
